class Timecard < ApplicationRecord
  ...
  def total_sat_hours
    ...
    if self.sat_hours > 8.0
      self.sat_overtime = self.sat_hours - 8.0
      self.sat_hours = 8.0
    else
  ...
  def total_sun_hours
    ...
    if self.sun_hours > 8.0
      self.sun_overtime = self.sun_hours - 8.0
      self.sun_hours = 8.0
    else
  ...
  def total_mon_hours
    ...
    if self.mon_hours > 8.0
      self.mon_overtime = self.mon_hours - 8.0
      self.mon_hours = 8.0
    else
  ...
  def total_tue_hours
    ...
    if self.tue_hours > 8.0
      self.tue_overtime = self.tue_hours - 8.0
      self.tue_hours = 8.0
    else
  ...
  def total_wed_hours
    ...
    if self.wed_hours > 8.0
      self.wed_overtime = self.wed_hours - 8.0
      self.wed_hours = 8.0
    else
  ...
  def total_thu_hours
    ...
    if self.thu_hours > 8.0
      self.thu_overtime = self.thu_hours - 8.0
      self.thu_hours = 8.0
    else
  ...
  def total_fri_hours
    ...
    if self.fri_hours > 8.0
      self.fri_overtime = self.fri_hours - 8.0
      self.fri_hours = 8.0
    else
